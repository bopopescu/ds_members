...
#     FROM boxes
#     WHERE id IN {id_list}
# """.format(id_list=id_list), subordinate)
...
d['count_subordinate'] = d['count_subordinate'].astype('int')

d['delta_values'] = d['count_redshift'] - d['count_subordinate']
